  ...
  return (
    <section className="bg-background py-8 px-4 sm:py-12 sm:px-6 md:py-16 md:px-8 lg:py-20 lg:px-12 xl:py-24 xl:px-16 2xl:px-20 w-full max-w-full overflow-x-hidden" style={{ overflow: "hidden", maxWidth: "100vw", width: "100%", boxSizing: "border-box", position: "relative" }}>
      <div className="max-w-xs mx-auto sm:max-w-sm md:max-w-2xl lg:max-w-4xl xl:max-w-6xl 2xl:max-w-7xl w-full min-w-0" style={{ maxWidth: "min(100vw, 1280px)", boxSizing: "border-box", width: "100%" }}>
        <div className="flex flex-col lg:flex-row items-start gap-8 lg:gap-16 xl:gap-20 w-full min-w-0" style={{ maxWidth: "100%", boxSizing: "border-box", width: "100%" }}>
          {/* Left Content */}
          <div className="flex flex-col gap-6 w-full lg:w-[329px] lg:flex-shrink-0 min-w-0" style={{ maxWidth: "min(100%, 329px)", boxSizing: "border-box", width: "100%" }}>
            ...
            <div className="flex justify-start items-center gap-2.5">
              ...
              <div className="flex flex-col sm:flex-row gap-4 w-full min-w-0 flex-1" style={{ maxWidth: "100%", boxSizing: "border-box" }}>
                {/* Exposure Assessment Card */}
                <div className="bg-card border-2 border-primary/20 p-4 sm:p-6 flex flex-col gap-6 sm:gap-8 w-full sm:w-1/3 h-auto sm:h-[550px] shadow-lg hover:shadow-xl hover:border-primary/40 transition-all duration-300 rounded-lg min-w-0 flex-shrink" style={{ maxWidth: "100%", boxSizing: "border-box" }}>
              <div className="flex flex-col gap-6 sm:gap-8">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex flex-col gap-3 min-w-0 flex-1">
                    <div className="flex flex-col gap-2">
                      <h3 className="font-inter text-lg sm:text-xl md:text-2xl lg:text-[28px] font-medium leading-[1.286] text-left text-primary break-words">
                        Exposure Assessment
                      </h3>
                    </div>
                    <h4 className="font-inter text-sm sm:text-base font-normal leading-[1.375] text-left text-muted-foreground break-words">
                      Proactively Identify Exposure Before It Becomes
                      Exploitable
                    </h4>
                  </div>
                </div>
                <p className="font-inter text-sm sm:text-base font-normal leading-[1.375] text-left text-muted-foreground break-words">
                ...
                <div className="bg-card border-2 border-accent/20 p-4 sm:p-6 flex flex-col gap-6 sm:gap-8 w-full sm:w-1/3 h-auto sm:h-[550px] shadow-lg hover:shadow-xl hover:border-accent/40 transition-all duration-300 rounded-lg min-w-0 flex-shrink" style={{ maxWidth: "100%", boxSizing: "border-box" }}>
              <div className="flex flex-col gap-6 sm:gap-8">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex flex-col gap-3 min-w-0 flex-1">
                    <div className="flex flex-col gap-2">
                      <h3 className="font-lato text-lg sm:text-xl md:text-2xl lg:text-[28px] font-medium leading-[1.286] text-left text-primary break-words">
                        Incident Response
                      </h3>
                    </div>
                    <h4 className="font-lato text-sm sm:text-base font-normal leading-[1.375] text-left text-muted-foreground break-words">
                      Automated, Regulator-Aligned Breach Response Workflows
                    </h4>
                  </div>
                </div>
                <p className="font-lato text-sm sm:text-base font-normal leading-[1.375] text-left text-muted-foreground break-words">
