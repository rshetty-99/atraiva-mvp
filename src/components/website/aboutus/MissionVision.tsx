...
export function MissionVision() {
  return (
    <section className="bg-white dark:bg-background flex items-center justify-center py-20 px-20">
      <div className="max-w-[1280px] w-full">
        <div className="flex items-center gap-[60px]">
          ...
          <div className="flex gap-4 w-[900px]">
            {/* Mission Card */}
            <div className="flex-1 bg-card border border-dashed border-primary/50 rounded-lg p-6">
            ...
            {/* Vision Card */}
            <div className="flex-1 bg-card border border-dashed border-accent/50 rounded-lg p-6">
              <div className="flex flex-col gap-8">
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 flex-shrink-0">
