...
export function CTA() {
  return (
    <section
      className="relative flex flex-col justify-center items-center gap-6 py-30 px-20 h-[750px] bg-black/80 backdrop-blur-md"
      style={{
    ...
    >
      ...
      <div className="relative z-10 flex flex-col justify-center gap-8">
        <div className="flex flex-col gap-6">
          <h2 className="font-['Amethysta'] text-[42px] font-normal leading-[1.26] text-left text-primary w-[494px]">
